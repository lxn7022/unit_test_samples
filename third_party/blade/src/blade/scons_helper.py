...
def generate_version_file(top_env, blade_root_dir, build_dir,
    ...
    t = time.localtime()
    built_time = "%d-%0.2d-%0.2d,%0.2d:%0.2d:%0.2d" % (t.tm_year, t.tm_mon, t.tm_mday, t.tm_hour, t.tm_min, t.tm_sec)
    ...
    print >>version_cpp, 'extern const char* const kSvnInfo[%d] = {%s};' % (
            svn_info_len, ', '.join(['"%s"' % v.strip() for v in svn_info_map.values()]))
    print >>version_cpp, 'extern const char kBuildType[] = "%s";' % profile
    print >>version_cpp, 'extern const char kBuildTime[] = "%s";' % built_time
